#!/bin/bash
# This bash script will enable the features specified on selected organizations 
...
# argument 4: comma separated list of orgs to enable
...
# Get the orgs to enable from the fourth argument
orgsToEnable=$4
